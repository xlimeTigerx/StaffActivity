...
-- CONFIG --
roleList = {
	['🔻 T-Mod | '] = {ROLE ID HERE, 1, 'WEBHOOK LINK HERE'},
	['🔻 Mod | '] = {ROLE ID HERE, 1, 'WEBHOOK LINK HERE'},
	['🔻 Mod+ | '] = {ROLE ID HERE, 1, 'WEBHOOK LINK HERE'},
	['🔻 Admin | '] = {ROLE ID HERE, 1, 'WEBHOOK LINK HERE'},
	['🔻 Senior Admin | '] = {ROLE ID HERE, 1, 'WEBHOOK LINK HERE'},
	['👷 Management | '] = {ROLE ID HERE, 5, 'WEBHOOK LINK HERE'},
	['🕵 Director | '] = {ROLE ID HERE, 2, 'WEBHOOK LINK HERE'},
	['👑 Network Owner | '] = {ROLE ID HERE, 3, 'WEBHOOK LINK HERE'},
}
